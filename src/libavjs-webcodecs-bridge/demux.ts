...
export async function audioStreamToConfig(
    ...
    switch (codecString) {
        ...
        case "aac":
        {
            ...
            if (profile < 0) profile += 127; // hate signed integers........
            ...
            switch (profile) {
                ...
                default:
                    console.warn('unknown codec profile', profile);
                    ret.codec = 'mp4a.40.2';
                    break;
            }
            if (extradata)
        ...
        default:
            console.warn('unknown codec ' + codecString, {
