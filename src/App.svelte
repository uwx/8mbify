<script lang="ts">
    ...
    async function start(e: Event) {
        ...
        ({ durationSeconds, frameRate: originalFrameRate, videoStreams, audioStreams } = await worker.start(file));
    ...
    async function transcode() {
        ...
        const video = await worker.transcode(actualVideoBitrateKilobits, actualAudioBitrateKilobits, width, height, frameRate);
